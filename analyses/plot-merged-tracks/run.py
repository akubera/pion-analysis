...
def main(argv=None):
    ...
    files = []
    files.append('/alice/data/2015/LHC15o/000246808/pass1/AOD194/0001/AliAOD.root')

    # loop = asyncio.get_event_loop()
    # loop.run_until_complete(run_multiproc_analysis(files))

    outname = Path('FooBar.root')

    dt = datetime.now()
    run_analysis(outname, files)
