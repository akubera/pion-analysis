void analysis_merge(const char *dir, Int_t stage=0)
{
...
// Set temporary compilation directory to current one
   ...
   TString outputFiles = "MrcResult-20190623174123.root";
   ...
   while((str=(TObjString*)iter->Next())) {
      ...
      merged = AliAnalysisAlien::MergeOutput(outputFile, outputDir, 7, stage);
      if (!merged) {
