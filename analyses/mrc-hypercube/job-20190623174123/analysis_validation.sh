...
if ! [ -f MrcResult-20190623174123.root ] ; then
   error=1
   echo "Output file MrcResult-20190623174123.root not found. Job FAILED !" >> stdout
   echo "Output file MrcResult-20190623174123.root not found. Job FAILED !" >> stderr
fi
